 ...
 *******************************************************************************
 */
package br.edu.ifes.tpa.silvio.exerc2;

import br.edu.ifes.tpa.silvio.exerc1.*;
...
public class ArvoreBinariaBusca<Valor extends Comparable<Valor>> {
    ...
    public List<Valor> valoresPreOrdem1() {
        List<Valor> lista = new ArrayList();
        valoresPreOrdem1(raiz, lista);
        return lista;
    }

    private void valoresPreOrdem1(No x, List<Valor> lista) {
        if (x == null) {
            return;
        }
        lista.add(x.valor);
        if(x.esquerda != null){
            No tmp = x.esquerda;
            valoresPreOrdem1(x.esquerda, lista);
             lista.add((Valor) "(");
        ...
        valoresPreOrdem1(x.esquerda, lista);
        valoresPreOrdem1(x.direita, lista);
    }
    /**
    ...
    public static void main(String[] args) {
        ...
        for (String s : bst.valoresPreOrdem1()) {
            System.out.print(s);
        }
