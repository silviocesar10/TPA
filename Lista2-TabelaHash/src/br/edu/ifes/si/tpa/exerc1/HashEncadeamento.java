 ...
 *******************************************************************************
 */
package br.edu.ifes.si.tpa.exerc1;
 ...
 */
public class HashEncadeamento<Valor> {

    private static final int INIT_CAPACITY = 4;

    private int n;             // número de valores
    private int m;             // tamanho da hash table
    private List<Valor>[] st;  // vetor de lista de valores
    ...
    private void redimensiona(int listas) {
        HashEncadeamento<Valor> temp = new HashEncadeamento<Valor>(listas);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) {
        HashEncadeamento<Integer> hash = new HashEncadeamento<Integer>();
